      ...
      <main className="flex-grow">
        ...
        <section className="bg-chessBlue text-white py-16">
          <div className="container mx-auto px-4">
            <Button asChild className="mb-6 bg-white text-chessBlue hover:bg-gray-100">
              <a href="/events">← Back to Events</a>
            </Button>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              ...
              <div>
                <h2 className="text-3xl font-bold mb-6 text-chessBlue">About This Event</h2>
                ...
                <div className="bg-gray-50 p-6 rounded-lg mb-8">
                  ...
                  <div className="space-y-2">
                    ...
                    <p><strong>Type:</strong> {event.type === 'upcoming' ? 'Upcoming Event' : 'Past Event'}</p>
                  </div>
                </div>
