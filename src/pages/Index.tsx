          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
              <div className="bg-white p-6 rounded-lg shadow-md text-center">
                ...
                <h3 className="font-bold text-xl text-chessBlue mb-2">Weekly Meetings</h3>
                <p className="text-gray-600">
                  Regular practice sessions and friendly matches to improve your skills.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md text-center">
                ...
                <h3 className="font-bold text-xl text-chessGreen mb-2">Tournaments</h3>
                <p className="text-gray-600">
                  Internal and inter-university competitions throughout the academic year.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md text-center">
                ...
                <h3 className="font-bold text-xl text-chessBlue mb-2">Workshops</h3>
                <p className="text-gray-600">
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Join us for our upcoming chess activities, tournaments, and workshops.
              </p>
            </div>
